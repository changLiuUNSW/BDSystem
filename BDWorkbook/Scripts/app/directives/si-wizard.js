...
(function () {
    ...
    .directive('siWizard', siWizard)
    .directive('siStep', siStep);
    /**
 * @ngdoc module
 * @name siWizard
 *
 * @description
 * Module to encapsulate the siWizard directive and siStep directive.
 */

    /**
     * @ngdoc directive
     * @name ng.directive:siWizard
     *
     * @description
        ...
        return {
            ...
            controller: ['$scope', function ($scope) {
                ...
                this.addStep = function (step) {
                    ...
                    // if a siSubmitController is being used, automatically add a _hidden_ 
                    ...
                    // bind to the submit complete event on the siSubmitController and 
                ...
                this.IsValid = function () {
                    if (steps.length)
                        ...
                        var currentStep = (steps.length > self.currentIndex) ? steps[self.currentIndex] : null;
                    return currentStep.formController.$invalid;
                }
                ...
                var onTabShow = function (activeTab, navigation, currentIndex) {
                    ...
                    // if a siStep is being used on the current tab, 
            ...
            compile: function (cElement, cAttributes, transclude) {
                return {
                    pre: function (scope, formElement, attributes, wizardController) {
                        ...
                        scope.si = scope.si || {};
                        scope.si[attributes.siWizard] = wizardController;
                    },
    ...
    /**
     * @ngdoc directive
     * @name ng.directive:siStep
     *
     * @description
     * Configures the specified element as a wizard-step.  Tells the parent siWizard
    ...
    function siStep() {
        return {
            restrict: 'A',
            require: ['^siWizard', '?form', '?siSubmit'],
