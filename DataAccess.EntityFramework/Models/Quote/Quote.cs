...
namespace DataAccess.EntityFramework.Models.Quote
{
    ...
    public class Quote : QuoteBase
    {
        ...
        public DateTime? LastClientEmailCheckDate { get; set; }

        public bool IsClientEmailSent { get; set; }
        public DateTime? ClientEmailSendDate { get; set; }
        public bool ClientEmailSendReminderDisabled { get; set; }
